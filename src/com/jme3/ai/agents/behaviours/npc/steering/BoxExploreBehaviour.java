...
public class BoxExploreBehaviour extends AbstractStrengthSteeringBehaviour {
     ...
     *                            explore the region more exhaustively.
     * 
     * @throws BoxExploreWithNegativeSubdivisionDistance If subdivisionDistance is lower or equals to 0
     * @throws BoxExploreWithNegativeBoxDimensions If boxWidthX, boxWidthZ or boxHeight is lower than 0
     * 
    ...
    /**
     * @see BoxExploreBehaviour#BoxExploreBehaviour(com.jme3.ai.agents.Agent, com.jme3.math.Vector3f, float, float, float, float) 
    ...
    private void construct(Vector3f boxCenter, float boxWidthX, float boxWidthZ, float boxHeight, float subdivisionDistance)
    {
        if(boxWidthX < 0 || boxWidthZ < 0 || boxHeight < 0)
            throw new BoxExploreWithNegativeBoxDimensions("Box width, depth and height must be positive.");
        else if(subdivisionDistance <= 0)
            throw new BoxExploreWithNegativeSubdivisionDistance("The subdivision distance must be higher than 0");
