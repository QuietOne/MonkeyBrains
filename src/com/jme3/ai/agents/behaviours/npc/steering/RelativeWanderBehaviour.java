 ...
 * state and make small random displacements to it each frame. Thus at one frame the
 * character may be turning up and to the right, and on the next frame will still be 
 * turning in almost the same direction."
 * 
 * @see WanderBehaviour
 * 
...
public class RelativeWanderBehaviour extends WanderBehaviour {
    ...
    /** 
     * @param relativeFactor How much should differ each new wander force ? A value 
    ...
    /** 
     * @see RelativeWanderBehaviour#RelativeWanderBehaviour(com.jme3.ai.agents.Agent, com.jme3.math.Vector3f, com.jme3.math.Vector3f, float) 
     * @see WanderBehaviour#WanderBehaviour(com.jme3.ai.agents.Agent, com.jme3.scene.Spatial) 
     */
