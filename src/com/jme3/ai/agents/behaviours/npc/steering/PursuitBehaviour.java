...
public class PursuitBehaviour extends SeekBehaviour {
    ...
    public PursuitBehaviour(Agent agent, Agent target, Spatial spatial) {
     ...
     public static class PursuitWithoutTarget extends IllegalBehaviour {
         private PursuitWithoutTarget(String msg) { super(msg); }
     }

     private void validateTarget(Agent target) {
         if(target == null) throw new PursuitWithoutTarget("The target can not be null.");
     }
